...
export default function DocumentationSection() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Track price drops on your purchases via Bright Data\nand get instant refund alerts.",
      image: "/analytics-dashboard.png",
    },
    {
      title: "AI-Powered Refunds",
      description: "Claude AI analyzes eligibility and generates\nrefund claims automatically.",
